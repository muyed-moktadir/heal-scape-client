...
//       <div className="hero-content flex flex-col mb-20 w-[90%] mx-auto items-center justify-center lg:flex-row lg:gap-40 ">
...
//                    <p role="alert" className="text-red-400 text-sm mt-2">service Name is required</p>
//                   )}
//                   {errors.serviceName?.type === "maxLength" && (
//                    <p role="alert" className="text-red-400 text-sm mt-2">maxLength is 10</p>
//                   )}
//                   {errors.serviceName?.type === "pattern" && (
//                    <p role="alert" className="text-red-400 text-sm mt-2">pattern required A to Z</p>
//                   )}
//                 </div>
//                 <div className="form-control">
...
//                     {...register("serviceCharge",{ required: true,max:100,min:50 })} //when using the hook no need to use placeholder
//                     aria-invalid={errors.serviceCharge? "true" : "false"}
//                   />

//                   {errors.serviceCharge?.type === "required" && (
//                    <p role="alert" className="text-red-400 text-sm mt-2">service Charge is required</p>
//                   )}
//                   {errors.serviceCharge?.type === "max" && (
//                    <p role="alert" className="text-red-400 text-sm mt-2">Max Charge is 100</p>
//                   )}
//                   {errors.serviceCharge?.type === "min" && (
//                    <p role="alert" className="text-red-400 text-sm mt-2">Min Charge is 50</p>
//                   )}
